...
void CameraComponent_V4L2::initCameraInfo()
{
    ...
    camInfo.lens_id = 0;
    camInfo.flags = CAMERA_CAP_FLAGS_CAPTURE_VIDEO | CAMERA_CAP_FLAGS_CAPTURE_IMAGE
        | CAMERA_CAP_FLAGS_HAS_MODES | CAMERA_CAP_FLAGS_CAN_CAPTURE_IMAGE_IN_VIDEO_MODE
...
{
    // TODO :: Get the details of the supported list from the camera device or from xml file
    camParam.setParameterSupported(CameraParameters::CAMERA_MODE, "still,video");
    camParam.setParameterSupported(CameraParameters::IMAGE_SIZE, "3264x2448,3264x1836,1920x1080");
    camParam.setParameterSupported(CameraParameters::IMAGE_FORMAT, "jpg,png");
    camParam.setParameterSupported(CameraParameters::PIXEL_FORMAT, "yuv420p,yuv422i");
    camParam.setParameterSupported(CameraParameters::WHITE_BALANCE_MODE, "auto,daylight");
    camParam.setParameterSupported(CameraParameters::VIDEO_SIZE,
                                   "1920x1080x30,640x480x30,640x480x60,320x240x30,320x240x60");
}
