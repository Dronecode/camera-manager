...
# avahi-glib
find_library(Avahi_GLIB_LIBRARY NAMES avahi-glib)

if (Avahi_GLIB_LIBRARY)
  set(Avahi_GLIB_FOUND ON)

  if (NOT TARGET "Avahi::glib")
    add_library("Avahi::glib" UNKNOWN IMPORTED)
    set_target_properties("Avahi::glib"
      PROPERTIES
      INTERFACE_INCLUDE_DIRECTORIES "${Avahi_GLIB_INCLUDE_DIRS}"
      IMPORTED_LOCATION "${Avahi_GLIB_LIBRARY}"
    )
